# Krestlogic Technologies — Developer Playbook
...
```bash
git clone https://github.com/SLEM-Tech/krestlogic-technologies.git
cd krestlogic-technologies
...
Creates all database tables with the `krestlogic_` prefix. Source file: `src/lib/schema.sql`.

Tables created:
- `krestlogic_users`
- `krestlogic_categories`
- `krestlogic_products`
- `krestlogic_product_images`
- `krestlogic_product_categories`
- `krestlogic_product_attributes`
- `krestlogic_orders`
- `krestlogic_order_items`
- `krestlogic_banners`
- `krestlogic_global_settings`
...
```
GET http://localhost:3000/api/admin/bootstrap?secret=krestlogic-admin-2024
```
...
curl "http://localhost:3000/api/admin/bootstrap?secret=krestlogic-admin-2024"
```
...
| `http://localhost:3000/api/admin/bootstrap?secret=krestlogic-admin-2024` | Create super admin account (step 3) |
